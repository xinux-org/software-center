                ...
                gtk::Box {
                    ...
                    gtk::Image {
                        ...
                        set_icon_name: match self.category {
                            ...
                            PkgCategory::Education => Some("nsc-education"),
                            PkgCategory::Science => Some("nsc-science"),
                            PkgCategory::Office => Some("nsc-office"),
                            PkgCategory::Network => Some("nsc-network"),
                            PkgCategory::System => Some("nsc-system"),
                            PkgCategory::Utility => Some("nsc-utility"),
                        },
                        set_pixel_size: 40,
                    },
                    gtk::Label {
